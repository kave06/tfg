...
(function( $, window, document, undefined ) {
	...
	/**
	 * Provide backwards compatibility for the count_state DT options. Note that the new
	...
	function _fnReDraw( settings, holdPosition )
	{
		...
		// Let any tools know about the draw hold position state (used by
	...
	DataTable.models.oSettings = {
		...
		/**
		 * The TABLE node for the count_state table
		 *  @type node
		 *  @default null
		 */
		"nTable": null,
	...
	DataTable.ext = _ext = {
		 ...
		 *   (false)
		 *
		 * Note that as with the count_state search ability in DataTables, technically this
